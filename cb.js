        ...
        Engines: {
            ...
            webknox: function (apiKey) {
                ...
                var capabilities = [
                    ...
                    "Ask for recipes like 'spaghetti recipes' or 'chocolate donut',
            ...
            duckduckgo: function () {
                ...
                // patterns that the engine can resolve
                var capabilities = [
                    "what service will be provide is like 'What service'?",
                    "Ask where something is like 'your address?'?",
                    "Ask about a person like 'payment mode'?",
                    "Say a food type name like 'type of food",
                    "Say a something like 'simpsons characters' to get information about food items",
                ];
